...
\usepackage{amsmath, amssymb, mathrsfs} % for math environments
...
\tableofcontents
\newpage\
\input{6_cardinal_number/chap6.tex}
\input{7_ORDERINGS_AND_ORDINALS/chap_main.tex}
% \input{4_inductive_def/chap4.tex}
